...
class HalvingProgressWidgetReceiver : GlanceAppWidgetReceiver() {
    ...
    override fun onDisabled(context: Context) {
        ...
        WorkManager.getInstance(context).cancelUniqueWork("halving_progress")
    }
    ...
    private fun setupPeriodicUpdate(context: Context) {
        ...
        val workRequest = PeriodicWorkRequestBuilder<HalvingProgressWorker>(
            15, TimeUnit.MINUTES,
            5, TimeUnit.MINUTES
