    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            BitcoinTimechainWidgetsTheme {
                ...
                Surface(
                    modifier = Modifier.padding(all = Dp(26.0F)),
...
fun Home(modifier: Modifier = Modifier) {
    ...
    Column(modifier = modifier) {
        ...
        Text(text = "The widgets automatic update every 15 minutes.", style = TextStyle(fontStyle = FontStyle.Italic))
        ...
        Spacer(modifier = Modifier.height(16.dp))
        Text(text = "Stay humble and stack sats", modifier = Modifier.align(Alignment.CenterHorizontally))
    }
}