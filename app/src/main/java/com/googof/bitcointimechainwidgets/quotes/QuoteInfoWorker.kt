...
class QuoteInfoWorker(
    ...
    companion object {
        ...
        private val uniqueWorkName = QuoteInfoWorker::class.java.simpleName

        fun enqueue(context: Context, force: Boolean = false) {
            val manager = WorkManager.getInstance(context)
            val requestBuilder = PeriodicWorkRequestBuilder<QuoteInfoWorker>(
    ...
    override suspend fun doWork(): Result {
        ...
        val glanceIds = manager.getGlanceIds(QuoteInfoGlanceWidget::class.java)
        return try {
    ...
    private suspend fun setWidgetState(glanceIds: List<GlanceId>, newState: QuoteInfo) {
        ...
        QuoteInfoGlanceWidget().updateAll(context)
    }
}